...
const Inputfield = () => {
    const [heading, setheading] = useState("Myself XYZ");
                            ...
                            <form className="form section1">
                                <div className="user-details">
                                    <div className="input-box">
                                        ...
                                        <input type="text" placeholder="Myself XYZ" onChange={(e) => { setheading(e.target.value) }} />
                                    </div>
                                    <div className="input-box">
                                    ...
                                    <div className="input-box">
                                        ...
                                        <input type="text" placeholder="ABES Engineering College" onChange={(e) => { setcollege(e.target.value) }} />
                                    </div>
                                    <div className="input-box">
                ...
                <div id="right-container">
                    <div className="container right">
                        ...
                        <div className="profile-preview">
                            <center><h1>Hello There 🤙, {heading === "" ? "Myself XYZ" : heading} </h1></center><br />
                            ...
                            <br />
                            <h3>{college === "" ? "ABES Engineering College" : college}</h3>
                            <br />
                            ...
                            <br />
                            {/* <p align="left"> <a href="https://github.com/ryo-ma/github-profile-trophy"><img src="https://github-profile-trophy.vercel.app/?username=prerna0202" alt="prerna0202" /></a> </p> */}
                            ...
                            {
                                languse === false ? ' ' : <p><img align="left" src={`https://github-readme-stats.vercel.app/api/top-langs?username=${githubprofile}&show_icons=true&locale=en&layout=compact`} alt="prerna0202" /></p>
                            }
                            {
                                readmestate === false ? ' ' : <p><img align="center" src={`https://github-readme-stats.vercel.app/api?username=${githubprofile}&show_icons=true&locale=en`} alt="prerna0202" /></p>
